...
>
> 与 `03_sft/troubleshooting.md`（9 类调优症状）、`03_sft/distillation_techniques.md`（白盒 KL / CoT 进阶）配套使用。
...
- **黑盒合规 trace SFT** → `configs/blackbox_claude_to_qwen7b.yaml`（保留历史文件名；若数据来自 Claude，必须先有 Anthropic 书面许可）
